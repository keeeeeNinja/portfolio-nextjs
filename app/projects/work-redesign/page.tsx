...
見分け方はシンプルです。「この仕事の目的は何か」「誰の意思決定に影響するか」を言葉にできないなら、意味が薄い可能性が高い。すぐに捨てられないなら、まず目的を確認するだけでも、削減のきっかけになります。`}
      ...
      >
        ...
        <div className="flex flex-col gap-6 pb-32 md:flex-row md:flex-wrap md:gap-4 lg:flex-nowrap">
          ...
          <article className="flex flex-col gap-3 pt-6 border-t border-[#0f766e]/30 md:w-[calc(50%-8px)] lg:flex-1">
            <div className="flex flex-col gap-2 flex-1">
              <span className="font-mono text-[11px] tracking-[0.5px] text-[#0f766e]/60 uppercase">
                SEO Writing & LP
              </span>
              <h3 className="font-serif font-normal text-[14px] leading-[1.3] tracking-[-0.3px] text-[#0f766e]/60 md:text-[16px]">
                仕事のやり方再設計
              </h3>
