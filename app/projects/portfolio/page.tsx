    ...
    <div id="top" className="min-h-screen bg-[#f8f6f3]">
      ...
      >
        ...
        <div className="flex flex-col gap-6 pb-32 md:flex-row md:flex-wrap md:gap-4 lg:flex-nowrap">
          ...
          <article className="flex flex-col gap-3 pt-6 border-t border-[#0034ad]/30 md:w-[calc(50%-8px)] lg:flex-1">
            <div className="flex flex-col gap-2 flex-1">
              <span className="font-mono text-[11px] tracking-[0.5px] text-[#0034ad]/60 uppercase">
                Website
              </span>
              <h3 className="font-serif font-normal text-[14px] leading-[1.3] tracking-[-0.3px] text-[#0034ad]/60 md:text-[16px]">
                ポートフォリオサイト
              </h3>
